...
INSERT INTO customer (
    dni, username, email, password, credit_card,
    total_flights, total_lodgings, total_tours,
    phone_number, enabled
) VALUES
('VIKI771012HMCRG093', 'john_doe', 'john@example.com',
 '$2a$10$OJ/Sf.WtAJqGyBgpn3kix.bRT7OXmEFF4LBSMjb.KSHne.1aFVq4W',
 '6473-9486-9372-0921', 0, 0, 0, '33-74-58-43', TRUE),

('BBMB771012HMCRR022', 'jane_smith', 'jane@example.com',
 '$2a$10$K/geCZgSsPGpXlTLg/N5AOgj3YIVSDkk5nX9aJCCla.bdciJCHf4u',
 '4463-3326-9980-5454', 0, 0, 0, '55-83-32-22', TRUE),

('WALA771012HCRGR054', 'admin', 'admin@example.com',
 '$2a$10$tWDdJRPcuJ1lAzcC5TKlH.PCAMkoqv4tc1QmUnY//ganc7AfBckHG',
 '6677-5244-94572-0165', 0, 0, 0, '33-24-41-54', TRUE);

-- Insertar relaciones roles-clientes
INSERT INTO customer_roles (customer_dni, role_id) VALUES
('VIKI771012HMCRG093', 2),  -- john_doe - CUSTOMER
('BBMB771012HMCRR022', 2),  -- jane_smith - CUSTOMER
